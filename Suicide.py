...
st.title("Európai Öngyilkossági Adatok (1985–2016)")

# Navigáció
page = st.sidebar.selectbox("Navigáció", ["Projektbemutató", "Vizualizációk"])
...
if uploaded_file:
    ...
    if page == "Projektbemutató":
        st.header("Projektbemutató – Európai Öngyilkossági Adatok Vizualizációja")

        st.subheader("1. Miről szól ez a projekt?")
        st.markdown("""
        Ez az interaktív dashboard az európai országok öngyilkossági adatait mutatja be 1985 és 2016 között. Célunk, hogy segítsünk jobban megérteni, hogyan alakulnak az öngyilkossági arányok különböző szempontok szerint: nem, korosztály, generáció, valamint gazdasági mutatók, például a GDP és a HDI alapján.
        """)

        st.subheader("2. Milyen adatokat használtunk?")
        st.markdown("""
        A „tisztitottEuropa.xlsx” fájl 33 európai ország több mint 30 évre visszamenő öngyilkossági és gazdasági adatait tartalmazza, megbízható forrásokból származóan.
        """)

        st.subheader("3. Miért fontosak ezek az adatok?")
        st.markdown("""
        Az öngyilkosság komoly társadalmi kérdés. Az adatok elemzése segíthet a megelőzésben és a mentális egészségpolitikák alakításában.
        """)

        st.subheader("4. Kiknek szól a projekt?")
        st.markdown("""
        Döntéshozóknak, mentálhigiénés szakembereknek, adatkutatóknak, és bárkinek, akit érdekel a téma.
        """)
        ...
        - mely korosztály vagy nem a leginkább érintett,
        - hogyan függ ez össze a gazdasági mutatókkal,
        - és hogy az idősebb férfiak különösen veszélyeztetettek.
        """)
